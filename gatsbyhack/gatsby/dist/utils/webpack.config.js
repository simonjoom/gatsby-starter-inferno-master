            ...
            function getResolve() {
                ...
                if ((process.env.NODE_ENV) == "production") {
                    ...
                    if (process.env.NODE_ENV == "inferno") {
                        resolve.alias["inferno"] = "inferno/dist/index.dev.esm.js";
                        resolve.alias["inferno-create-element"] = "inferno-create-element/dist/index.dev.esm.js";
                        resolve.alias["inferno-create-class"] = "inferno-create-class/dist/index.dev.esm.js";
                        resolve.alias["inferno-hydrate"] = "inferno-hydrate/dist/index.dev.esm.js";
                        resolve.alias["inferno-shared"] = "inferno-shared/dist/index.dev.esm.js";
                        resolve.alias["inferno-vnode-flags"] = "inferno-vnode-flags/dist/index.dev.esm.js";
                        resolve.alias['react-dom/server'] = 'inferno-server/dist/index.dev.esm.js';
                        resolve.alias['react'] = 'inferno-compat/dist/index.dev.esm.js';
                        resolve.alias['react-dom'] = 'inferno-compat/dist/index.dev.esm.js';
                    } else {
                        resolve.alias["react-hot-loader"] = path.dirname(require.resolve(`react-hot-loader/package.json`));
                    }
                }
                /* 
                      return {
            ...
            if (stage === `build-javascript`) {
                config.optimization = {
                    ...
                    minimizer: [ // TODO: maybe this option should be noMinimize?
                        !program.noUglify && plugins.minifyJs(), plugins.minifyCss()
                    ].filter(Boolean)
                };
            }
