...
function cloneVNode(vNodeToClone, props) {
    ...
    if (flags & 14 /* Component */) {
        ...
        newVNode = createVNode(flags, vNodeToClone.type, className, null, 1 /* HasInvalidChildren */, combineFrom(vNodeToClone.props, props), key, ref);
    }
    else if (flags & 16 /* Text */) {
        return createTextVNode(props ? props.children : vNodeToClone.children);
    }
