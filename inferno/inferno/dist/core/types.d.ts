...
export declare type ClipboardEvent<T> = SemiSyntheticEvent<T>;
export declare type CompositionEvent<T> = SemiSyntheticEvent<T>;
export declare type DragEvent<T> = InfernoMouseEvent<T>;
export declare type FocusEvent<T> = SemiSyntheticEvent<T>;
...
export declare type InernoWheelEvent<T> = InfernoMouseEvent<T> & WheelEvent;
...
export declare type WheelEventHandler<T = Element> = EventHandler<InernoWheelEvent<T>>;
...
declare global {
    ...
    namespace JSX {
        ...
        interface ElementClass extends IComponent<any, any> {
            render(nextProps: any, nextState: any, nextContext: any): InfernoNode | undefined;
        }
